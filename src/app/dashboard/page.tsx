...
export default function Dashboard() {
  ...
  if (loading && merchants.length === 0) {
    return (
      <div className="flex-grow bg-bg-base flex items-center justify-center text-ink-secondary font-mono text-xs h-screen">
  ...
  return (
    <>
      ...
      <main className="flex-1 bg-bg-base text-ink-primary max-w-7xl mx-auto w-full px-6 lg:px-8 pt-24 pb-16">
        {/* HEADER SELECTOR */}
